...
public class Migrator {
    ...
    private static UpdateOneModel<Document> transformRating(Document doc) {
        try {
            ...
            return new UpdateOneModel<Document>(new Document("_id", doc.get("_id")), new Document("$set", new
    ...
    public static void main(String[] args) {
        ...
        // format pattern
        Bson type = type("lastupdated", "string");
        ...
        for (Document doc : movies.find(type)) {
